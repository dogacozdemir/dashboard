    ...
    >
      ...
      {platform === 'tiktok' && (
        <svg viewBox="0 0 24 24" className="w-4 h-4 text-white" fill="currentColor" aria-hidden>
          <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64v-3.4a6.34 6.34 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.14-5.1V9.66a8.16 8.16 0 0 0 4.77 1.52v-3.5a4.85 4.85 0 0 1-.32-.z" />
        </svg>
      )}
    </span>
  );
